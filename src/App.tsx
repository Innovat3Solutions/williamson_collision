    ...
    >
      ...
      <div className="relative h-full flex justify-between items-center w-full px-4 sm:px-6 lg:px-8 max-w-none gap-4">
        ...
        >
          <img
            src={LOGO.brand}
            alt="Williamson Collision Center Cadillac"
            className="h-[5.25rem] sm:h-24 lg:h-[7.5rem] w-auto max-w-[72vw] object-contain object-left"
            loading="eager"
            decoding="async"
          />
        </a>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-8 md:px-12">
        <div className="max-w-3xl">
          <h2 className="font-label text-xs tracking-widest-custom uppercase text-primary-container mb-6 border-l-2 border-primary-container pl-4 anim-fade-up" style={{ animationDelay: '0.15s' }}>
            South Miami&apos;s Manufacturer-Certified Collision Center
          </h2>
    ...
    <section data-tone="dark" className="py-24 bg-background relative">
      <div className="max-w-7xl mx-auto px-8 md:px-12">
        <div className="mb-16 reveal">
          <h2 className="font-label text-xs tracking-widest-custom uppercase text-primary-container mb-4 border-l-2 border-primary-container pl-4">The Williamson-Collision Standard</h2>
    ...
    <section id="location" data-tone="light" className="py-24 bg-paper border-t border-paper-line">
      <div className="max-w-7xl mx-auto px-8 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="reveal reveal-left">
            <h2 className="font-headline text-3xl font-bold uppercase tracking-tighter text-ink mb-6">Williamson-Collision Coordinates</h2>
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-12 pt-14 md:pt-16 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8">
          ...
          <div className="md:col-span-4">
            <a href="#" aria-label="Williamson Collision Center home" className="inline-flex items-center overflow-hidden h-32 md:h-40">
              <img
                src={LOGO.brand}
                alt="Williamson Collision Center Cadillac"
            ...
            <p className="mt-6 font-body text-sm text-ink-muted leading-relaxed max-w-xs">
              Proudly serving Miami and the surrounding communities with certified collision repair you can trust.
            </p>
